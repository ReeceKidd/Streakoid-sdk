        ...
        switch (_b.label) {
          case 0:
            getAllSoloStreaksURL =
              ...
              "/" +
              RouterCategories_1.default.streakTrackingEvents +
              "?";
            if (type) {
              getAllSoloStreaksURL =
                getAllSoloStreaksURL + "type=" + type + "&";
            }
            if (userId) {
              getAllSoloStreaksURL =
            ...
            if (streakId) {
              getAllSoloStreaksURL =
                getAllSoloStreaksURL + "streakId=" + streakId;
            }
            ...
            return [
              ...
              axios_1.default.post(
                applicationUrl +
                  ...
                  "/" +
                  RouterCategories_1.default.streakTrackingEvents,
                { type: type, streakId: streakId, userId: userId }
              )
            ];
          case 1:
            data = _b.sent().data;
