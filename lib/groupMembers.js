...
var GroupStreakRouterCategories_1 = __importDefault(
  require("./GroupStreakRouterCategories")
);
exports.default = function(applicationUrl) {
  var create = function(_a) {
    var friendId = _a.friendId,
      groupStreakId = _a.groupStreakId,
            ...
            return [
              ...
              axios_1.default.post(
                applicationUrl +
                  ...
                  groupStreakId +
                  "/" +
                  GroupStreakRouterCategories_1.default.members,
                { friendId: friendId },
                {
                  headers:
                    ((_b = {}),
