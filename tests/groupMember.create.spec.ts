...
describe("POST /group-streaks/:id/members", () => {
    ...
    test(`adds friend to group streak`, async () => {
        ...
        expect(updatedGroupStreak.timezone).toEqual(timezone)
        ...
        expect(Object.keys(updatedGroupStreak.creator).sort()).toEqual(["_id", "username"].sort());
        ...
        expect(member.groupMemberStreak.groupStreakId).toEqual(createdGroupStreakId)
        expect(member.groupMemberStreak.timezone).toEqual(timezone)
        ...
        expect(friendMember.groupMemberStreak.groupStreakId).toEqual(createdGroupStreakId)
        expect(friendMember.groupMemberStreak.timezone).toEqual(timezone)
